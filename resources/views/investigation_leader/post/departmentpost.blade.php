...
<head>
    ...
    <meta name="description" content="Responsive HTML Deppartment Head Dashboard Template based on Bootstrap 5">
    <meta name="author" content="NobleUI">
    <meta name="keywords" content="Deppartment Head, dashboard, responsive, bootstrap, template, html, css">

    <title>Deppartment Head Panel | Criminal Information Inter-Office Communication</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper" style="margin-top: 0; padding: 0;">
            <h1 style="text-align: center; position: fixed; width: 100%; background: #070d19; z-index: 100; padding: 10px 0; color: white;">
                {{ $profileData->department }} Department Post
            </h1>
            <div class="align-items-start" style="width: 100%;">
                <div class="posting_place">
                    ...
                    @if ($profileData->department == 'IT')
                        ...
                        <div style="display:flex;flex-direction:row;gap:10px">
                            <div class="single_post"  style="width: 60%;margin:5px 0px 0px 45px;padding:5px 0px 10px 40px ">
                                <div>
                                    ...
                                    <img src="{{ asset('upload/collegeposts/' . $post->photo) }}" class="wd-70" alt="...">
                                    </div>
                        ...
                        <form class="mb-3">
                            <a href="{{ route('departmenthead.profile') }}">
                            ...
                            <span class="tx-16 fw-bolder">{{ $profileData->name }}</span>
                        </form>

                    @elseif ($profileData->collage == 'engineering')
                        <p>Collage: Engineering</p>
                    @else
                        <p>Collage: {{ $profileData->collage ? $profileData->collage : 'Unknown' }}</p>
            ...
            <div class="action-buttons"> 
                ...
                <form action="{{route('admin.editpost')}}">
                    <button type="submit" class="btn btn-primary">Edit Post</button>
                </form>
                <form action="{{route('admin.deletepost')}}">
