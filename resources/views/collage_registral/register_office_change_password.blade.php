  ...
  <div class="col-md-8 col-xl-8 middle-wrapper">
    ...
    <div class="card">
              <div class="card-body">
								...
								<h6 class="card-title">Collage Registral change password</h6>

								<form class="forms-sample" method="POST" action="{{route('collageregistral.update.password')}}" enctype='multipart/form-data'>
								@csrf	
