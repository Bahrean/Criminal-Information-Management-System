...
<li class="nav-item {{ request()->routeIs('common.posts.collegepost') ? 'active' : '' }}">
...
<li class="nav-item {{ request()->routeIs('common.posts.departmentpost') ? 'active' : '' }}">
...
<li class="nav-item {{ request()->routeIs('collageregistral.showmembers') ? 'active' : '' }}">
