...
@endphp
                        ...
                        <div style="display:flex;flex-direction:row;gap:10px">
                            ...
                            <div class="post-container">
                                ...
                                <div class="image-container">
                                    <img src="{{ asset('upload/collegeposts/' . $post->photo) }}" class="wd-70" alt="Post Image">
                                </div>
                            ...
                            .image-container img {
                                ...
                                <div style="display:flex;flex-direction:row;justify-content:space-between">
                                    ...
                                    @else
                                        <p style="margin-top:20px;">{{ $post->updated_at }} ( {{ $post->posted_by_college }} College )</p>
                                    @endif
                                    <div style="display:flex;flex-direction:row;justify-content:end;gap:20px;bottom:20px">
                                        @if($profileData->name==$post->posted_by_name)
                                            <form action="{{route('common.editcollegepost', $post->id)}}"> 
                                                <button type="submit" class="btn btn-primary">Edit Post</button>
                                            </form>
                                        @endif
                                        @if($profileData->name==$post->posted_by_name ||$profileData->role=='admin')
                                            <form action="{{route('common.deletecollegepost', $post->id)}}">
    ...
    @endif
            ...
            <div class="action-buttons"> 
                ...
                <form action="{{route('common.addcollegepost')}}" class="forms-sample" enctype='multipart/form-data'>
