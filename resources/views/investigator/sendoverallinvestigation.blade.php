                        ...
                        <form class="forms-sample" method="POST" action="{{route('investigator.sentinvestigationreporttoleader')}}" enctype='multipart/form-data' novalidate>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control @error('age') is-invalid @enderror" 
                                               id="age" name="age" placeholder=" " value="{{ old('age') }}" min="1" max="120">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label"><i class="fas fa-comment me-2"></i>Interview Notes</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- Video Evidence -->
                                    <div class="mb-3 file-upload-wrapper">
                                        <label class="form-label"><i class="fas fa-video me-2"></i>Video Evidence</label>
                                        <div class="custom-file">
                                            <input type="file" class="form-control @error('video_evidence') is-invalid @enderror" 
                                                   id="video_evidence" name="video_evidence" accept="video/*">
                                            <label class="custom-file-label" for="video_evidence">Choose file</label>
                                            @error('video_evidence')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    ...
                                    <!-- Audio Evidence -->
                                    <div class="mb-3 file-upload-wrapper">
                                        <label class="form-label"><i class="fas fa-microphone me-2"></i>Audio Evidence</label>
                                        <div class="custom-file">
                                            <input type="file" class="form-control @error('audio_evidence') is-invalid @enderror" 
                                                   id="audio_evidence" name="audio_evidence" accept="audio/*">
                                            <label class="custom-file-label" for="audio_evidence">Choose file</label>
                                            @error('audio_evidence')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label"><i class="fas fa-file-alt me-2"></i>Additional Notes</label>
                                        <textarea class="form-control @error('additional_notes') is-invalid @enderror" 
                                                  id="additional_notes" name="additional_notes" rows="4">{{ old('additional_notes') }}</textarea>
        ...
        $('#personal_photo').change(function(e) {
            ...
            if (file && file.type.match('image.*')) {
                ...
                reader.onload = function(e) {
                    container.append(`<img src="${e.target.result}" class="preview-media" alt="Photo preview">`);
                }
