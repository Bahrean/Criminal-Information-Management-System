...
.typing-logo-text {
    ...
    animation: typing 12s steps(22) infinite, blink 0.6s step-end infinite;
}
...
.noble-ui-logo:hover .typing-logo-text {
    color:rgb(231, 230, 224); /* Add a brighter yellow glow on hover */
              ...
              <div class="row">
                ...
                <div class="col-md-8 ps-md-0">
                  ...
                  <a href="#" class="noble-ui-logo logo-light d-block mb-2">
                      <span class="typing-logo-text" style="color: white;font-weight: bold;">Wollo University</span>
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('login') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input style="icon-color:white;" type="password" class=" form-control" id="password" name="password" placeholder="Enter your password" required>
                      </div>
